...
public class Usuario {
	...
	public Usuario(Integer id, String nombre, String apellido, String email, String password, String documento,
			String tipoDocumento, String curso, String celular, Date fechaNacimiento, Date fecharegistro,
	...
	public String toString() {
		return "Usuario [id=" + id + ", nombre=" + nombre + ", apellido=" + apellido + ", email=" + email
				...
				+ ", curso=" + curso + ", celular=" + celular + ", fechaNacimiento=" + fechaNacimiento
				+ ", fecharegistro=" + fecharegistro + ", ultimoAcceso=" + ultimoAcceso + ", activo=" + activo
				+ ", avatar=" + avatar + "]";
	}
